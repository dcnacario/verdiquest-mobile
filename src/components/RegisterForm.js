...
const RegisterForm = ({onRegister}) => {
    ...
    const handleSubmit = () => {
        ...
        axios.post('http://192.168.1.13:3000/register', userData)
             .then(response => {
                ...
                >
                    <View style={{flexDirection: 'row'}}>
                        <View style={{flexDirection: 'row', marginHorizontal: 5}}>
                            <RadioButton value="male" color={`${theme.colors.primary}`} uncheckedColor={`${theme.colors.primary}`}/>
                            <Text style={styles.labelText}>Male</Text>
                        </View>
                        <View style={{flexDirection: 'row', marginHorizontal: 5}}>
                            <RadioButton value="female" color={`${theme.colors.primary}`} uncheckedColor={`${theme.colors.primary}`}/>
                            <Text style={styles.labelText}>Female</Text>
                        </View>
                        <View style={{flexDirection: 'row', marginHorizontal: 5}}>
                            <RadioButton value="others" color={`${theme.colors.primary}`} uncheckedColor={`${theme.colors.primary}`}/>
